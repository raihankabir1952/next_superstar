      ...
      <Container>
        <div className="flex flex-col items-center gap-[50px]">
          <div className="flex flex-col items-center gap-5">
            <SectionBadge>Expert Panel</SectionBadge>
          ...
          <div className="grid w-full grid-cols-1 gap-[30px] sm:grid-cols-2 lg:grid-cols-3">
            {judges.map((judge) => (
              <article
                key={judge.name}
                className="group relative h-[450px] overflow-hidden rounded-[50px] bg-black"
              >
                <Image
                  src={judge.image}
                  alt={judge.name}
                ...
                <div className="absolute inset-x-0 bottom-0 flex flex-col gap-5 p-[30px] pb-10 text-white">
                  <div className="flex items-center gap-[6px]">
                    <StarIcon size={20} />
                    <span className="text-[16px] font-normal">{judge.tag}</span>
                  </div>
                  ...
                  <div className="flex flex-col gap-[6px]">
                    ...
                    <p className="text-[18px] font-normal">{judge.role}</p>
                  </div>
                </div>
              </article>
            ))}
